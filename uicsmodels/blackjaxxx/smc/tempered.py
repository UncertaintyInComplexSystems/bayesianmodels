...
def build_kernel(
    ...
    def kernel(
        ...
        # pass SMC tempering parameter lmbda into gibbs_fn
        shared_mcmc_step_fn = partial(mcmc_step_fn, temperature=state.lmbda, **shared_mcmc_parameters)
...
def as_top_level_api(
    ...
    """
    jax.debug.print('tempered.py as top level api')  # TODO: delete this function?
    kernel = build_kernel(
        logprior_fn,
        loglikelihood_fn,
        mcmc_step_fn,
